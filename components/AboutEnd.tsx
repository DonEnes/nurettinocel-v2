                ...
                <div className="grid lg:grid-cols-2 gap-16 md:gap-20 items-center">
                    ...
                    <div className="relative">
                        ...
                        <motion.div
                            ...
                            className="absolute left-[-190px] sm:left-[-310px] top-1/2 -translate-y-1/2 transform -rotate-90 origin-center">
                            <span className="text-6xl sm:text-8xl tracking-wider text-black whitespace-nowrap">Webdesigner</span>
                        </motion.div>
                    </div>
